...
namespace MiCalculadora
{
    public partial class FormCalculadora : Form
    {
        ...
        private void btnOperar_Click(object sender, EventArgs e)
        {
            ...
            {
                sb.AppendFormat("0  +  {0} = {1}", this.txtNumero2.Text, this.lblResultado.Text);
                sb.AppendLine();
            }
            else
            {
                sb.AppendFormat("{0}  {1}  {2} = {3}", this.txtNumero1.Text, this.cmbOperador.Text, this.txtNumero2.Text, this.lblResultado.Text);
                sb.AppendLine();
            }
